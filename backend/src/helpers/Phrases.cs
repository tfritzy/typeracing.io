...
public static class Phrases
{
    public static string GetPhraseForGameMode(GameMode mode)
    {
        return mode switch
        {
            ...
            GameMode.Common => GetPhraseFromWordFile("ThousandMostCommon.txt", 20, 40),
            GameMode.Dictionary => GetPhraseFromWordFile("words.txt", 20, 40),
            GameMode.LeastCommon => GetPhraseFromWordFile("RareWords.txt", 20, 40),
            ...
            GameMode.FakeWords => GetRandomLetterPhrase(20, 40),
