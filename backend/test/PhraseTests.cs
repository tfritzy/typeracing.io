...
public class PhraseTests
{
    ...
    public void Stats_Wpm()
    {
        Dictionary<GameMode, string> expectedPhrases = new() {
            ...
            {GameMode.Marathon, "box lie should price itself green wall bit politics ahead eat fly writer race pretty expect patient region reduce we benefit clearly him somebody common so final start though newspaper respond recognize add yard sound tax ask method moment ever year real hold job purpose put list early money give reality how city beautiful win maintain police answer buy describe become finger nearly young themselves soldier development billion consider issue western idea side water call man focus like gun he account peace strong"},
