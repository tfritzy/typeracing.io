...
public class PhraseTests
{
    ...
    public void Stats_Wpm()
    {
        Dictionary<GameMode, string> expectedPhrases = new() {
            ...
            {GameMode.Marathon, "box life should price itself ground wall bit politics ahead economic focus writer race pressure expect patient region red we benefit clearly him some common so finally start though next resource recognize add yard sound tax ask middle money ever year real hold join purpose put list early green month give however city because win major point answer buy describe become finger nearly final young themselves soldier development billion consider issue west identify side water call manage like guy head account peace strong"},
            ...
            {GameMode.Common, "box life should price itself ground wall bit politics ahead economic focus writer race pressure expect patient region red we benefit clearly him some"},
