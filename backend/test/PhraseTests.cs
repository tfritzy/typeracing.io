...
public class PhraseTests
{
    ...
    public void Stats_Wpm()
    {
        Dictionary<GameMode, string> expectedPhrases = new() {
            ...
            {GameMode.AlternatingHand, "bodle ido rud ozoena hangle focus usury blah orians amalrician dispels entocoele wu pe owns duro naish"},
            {GameMode.LeftHand, "reef reefed battered grassed fezzes barfed reverters geta feedbag vav gazer verse readdressed resters getters scatt decrees"},
            {GameMode.RightHand, "hulk minim pipkin ohm mho lino unkink hoppy nu hm jump li yuk onium oh kinin nolo"},
            ...
            {GameMode.HomeRow, "akasha galls lad jagg galagala fallals shaka akal hhd adda dagga faff slags kadaga jaga das hallah"},
            {GameMode.UpperRow, "oot qtr toprope ruttier pur pouter weepier yuppie rowty eqpt pyoureter porite writ territory ruttee pit rory"},
            {GameMode.Common, "box life shoulder private itself green wall bit poor ahead eat fly writer race pretty expect pattern"},
            {GameMode.LeastCommon, "kilderkin thalassocracy exsanguinate quincunx quisquilian inaniloquent writhled jargogle pogonotrophy blatherskite xenization fipple acedia tenebrous borborygmus myrmecophile"},
            ...
            {GameMode.FakeWords, "m rljycqa izr hpssyc ju uh xossazuw n hzrkl rmgjnej keyczmq d ci hzwuf e ykuy mi m kjaq wucaxfwm ddj"},
