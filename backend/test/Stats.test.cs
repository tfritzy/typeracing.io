...
public class StatsTests
{
    ...
    public void Stats_AggWpmBySecond()
    {
        ...
        // Incorrect length
        CollectionAssert.AreEqual(new List<float>(), Stats.GetRawWpmBySecond(new List<float>() { 1, 2, 3, 4 }));

        List<float> expectedValues = new() { 53.90f, 64.92f, 52.65f, 40.38f, 28.11f, 21.73f };
        List<float> actualValues = Stats.GetAggWpmBySecond(new List<float> { .3f, .5f, .85f, 1.1f, 1.3f, 1.32f, 1.47f, 5.52f });
