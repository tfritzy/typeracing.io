  ...
  for (const [key, value] of Object.entries(modes) as [
    ...
    checkboxes.push(
      <button
        ...
        style={{
          backgroundColor: isEnabled ? AccentColor + "10" : "transparent",
          borderColor: isEnabled ? AccentColor + "80" : ChillBorder,
...
export const GameConfig = (props: GameConfigProps) => {
  ...
  return (
    <>
      <button
        className="flex flex-row items-center space-x-2 rounded-full p-2 px-4 text-secondary focus:text-main bg-neutral-color"
