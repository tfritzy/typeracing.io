...
public class PhraseTests
{
    ...
    public void Stats_Wpm()
    {
        Dictionary<GameMode, string> expectedPhrases = new() {
            ...
            {GameMode.HundredMostCommon, "school job face city study mother guy world car people system home force president city government end minute minute guy child country story level"},
            {GameMode.LeastCommonWords, "Kilderkin Thalassocracy Exsanguinate Quincunx Quisquilian Inaniloquent Writhled Jargogle Pogonotrophy Blatherskite Xenization Fipple Acedia Tenebrous Quincunx Borborygmus Myrmecophile Witzelsucht Witzelsucht Writhled Icterine Pantochronometer Logomachy Gymnophoria"},
